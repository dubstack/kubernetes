...
func (s *KubeletServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&s.CgroupPerQOS, "cgroup-per-qos", s.CgroupPerQOS, "Whether the Kubelet should have the QoS cgroup hierarchy, if true top level qos and pod cgroups are created.")
