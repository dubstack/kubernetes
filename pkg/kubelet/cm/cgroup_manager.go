...
// NewCgroupManagerImpl is a factory method that returns a CgroupManager
func NewCgroupManagerImpl() CgroupManager {
...
func (m *cgroupManagerImpl) Destroy(cgroupConfig *CgroupConfig) error {
	...
	fsCgroupManager, err := getLibcontainerCgroupManager(cgroupConfig)
	if err != nil {
