			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[51] {
					...
					if false {
						...
						r.EncodeBool(bool(x.CgroupPerQOS))
					}
				} else {
					r.EncodeBool(false)
				}
				...
				if yyq2[51] {
					z.EncSendContainerState(codecSelfer_containerMapKey1234)
					r.EncodeString(codecSelferC_UTF81234, string("CgroupPerQOS"))
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					yym174 := z.EncBinary()
					_ = yym174
					if false {
...
func (x *KubeletConfiguration) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "CgroupPerQOS":
			if r.TryDecodeAsNil() {
				x.CgroupPerQOS = false
			} else {
				x.CgroupPerQOS = bool(r.DecodeBool())
			}
		case "runtimeCgroups":
			if r.TryDecodeAsNil() {
				x.RuntimeCgroups = ""
		...
		case "outOfDiskTransitionFrequency":
			if r.TryDecodeAsNil() {
				...
				yyv93 := &x.OutOfDiskTransitionFrequency
				yym94 := z.DecBinary()
				_ = yym94
				if false {
		...
		case "evictionPressureTransitionPeriod":
			if r.TryDecodeAsNil() {
				...
				yyv103 := &x.EvictionPressureTransitionPeriod
				yym104 := z.DecBinary()
				_ = yym104
				if false {
...
func (x *KubeletConfiguration) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv151 := &x.StreamingConnectionIdleTimeout
		yym152 := z.DecBinary()
		_ = yym152
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		yyv153 := &x.NodeStatusUpdateFrequency
		yym154 := z.DecBinary()
		_ = yym154
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		yyv173 := &x.RuntimeRequestTimeout
		yym174 := z.DecBinary()
		_ = yym174
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		yyv198 := &x.OutOfDiskTransitionFrequency
		yym199 := z.DecBinary()
		_ = yym199
		if false {
	...
	if r.TryDecodeAsNil() {
		...
		yyv208 := &x.EvictionPressureTransitionPeriod
		yym209 := z.DecBinary()
		_ = yym209
		if false {
