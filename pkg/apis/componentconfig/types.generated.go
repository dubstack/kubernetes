			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[54] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF81234, string(x.CgroupsRoot))
					}
				} else {
					r.EncodeString(codecSelferC_UTF81234, "")
				}
				...
				if yyq2[54] {
					z.EncSendContainerState(codecSelfer_containerMapKey1234)
					r.EncodeString(codecSelferC_UTF81234, string("cgroupsRoot"))
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					yym183 := z.EncBinary()
					_ = yym183
					if false {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "cgroupsRoot":
			if r.TryDecodeAsNil() {
				...
				x.CgroupsRoot = string(r.DecodeString())
			}
